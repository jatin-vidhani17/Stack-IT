    ...
    return (
      <div className="mt-2">
        ...
        <p className="text-xs text-gray-400">
          Password strength: <span className={`text-${colors[strength - 1]?.replace('bg-', '') || 'gray-400'}`}>
      ...
      <header className="border-b border-gray-700 px-4 py-3">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          ...
          <div className="text-sm text-gray-400">
            Already have an account? <button className="text-blue-400 hover:text-blue-300 underline" onClick={handleSignIn}>Sign in</button>
          </div>
        </div>
      </header>
